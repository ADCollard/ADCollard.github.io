dset ^avhrr_metop-a.%y4%m2%d2%h2.ieee_d
options template big_endian sequential
undef -999.
title avhrr      metop-a       3
*XDEF is scan position
*YDEF is channel number
*  y=    1, channel=    3 , iuse=  2 , error=    0.600 , wlth=      3.72 , freq=  80642.29
*  y=    2, channel=    4 , iuse=  2 , error=    0.680 , wlth=     10.80 , freq=  27763.93
*  y=    3, channel=    5 , iuse=  1 , error=    0.720 , wlth=     11.95 , freq=  25094.13

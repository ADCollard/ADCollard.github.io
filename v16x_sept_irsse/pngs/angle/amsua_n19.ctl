dset ^amsua_n19.%y4%m2%d2%h2.ieee_d
options template big_endian sequential
undef -999.
title amsua      n19          15
*XDEF is scan position
*YDEF is channel number
*  y=    1, channel=    1 , iuse=  1 , error=    2.500 , wlth=  12596.46 , freq=     23.80
*  y=    2, channel=    2 , iuse=  1 , error=    2.200 , wlth=   9546.89 , freq=     31.40
*  y=    3, channel=    3 , iuse=  1 , error=    2.000 , wlth=   5960.06 , freq=     50.30
*  y=    4, channel=    4 , iuse=  1 , error=    0.550 , wlth=   5677.82 , freq=     52.80
*  y=    5, channel=    5 , iuse=  1 , error=    0.300 , wlth=   5593.55 , freq=     53.60
*  y=    6, channel=    6 , iuse=  1 , error=    0.230 , wlth=   5510.88 , freq=     54.40
*  y=    7, channel=    7 , iuse= -1 , error=    0.230 , wlth=   5456.78 , freq=     54.94
*  y=    8, channel=    8 , iuse= -1 , error=    0.250 , wlth=   5401.79 , freq=     55.50
...
*  y=   15, channel=   15 , iuse=  1 , error=    3.500 , wlth=   3368.08 , freq=     89.01

dset ^saphir_meghat.%y4%m2%d2%h2.ieee_d
options template big_endian sequential
undef -999.
title saphir     meghat        6
*XDEF is scan position
*YDEF is channel number
*  y=    1, channel=    1 , iuse=  1 , error=    1.750 , wlth=   1635.44 , freq=    183.31
*  y=    2, channel=    2 , iuse=  1 , error=    1.410 , wlth=   1635.44 , freq=    183.31
*  y=    3, channel=    3 , iuse=  1 , error=    1.240 , wlth=   1635.44 , freq=    183.31
*  y=    4, channel=    4 , iuse=  1 , error=    1.130 , wlth=   1635.44 , freq=    183.31
*  y=    5, channel=    5 , iuse=  1 , error=    1.070 , wlth=   1635.44 , freq=    183.31
*  y=    6, channel=    6 , iuse=  1 , error=    1.010 , wlth=   1635.44 , freq=    183.31
